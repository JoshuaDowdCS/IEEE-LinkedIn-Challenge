...
const clubs = [
  ...
  { name: "Chapman Entrepreneurship Organization", desc: "Chapman Entrepreneurship Organization is more than just a network; it's a community of like-minded individuals dedicated to personal and professional growth, innovation, and success. Chapman Entrepreneurship Organization is here to equip aspiring entrepreneurs with the essential knowledge, invaluable connections, and vital resources necessary to embark on their unique journey.", handle: "@chapman__entrepreneurs", link: "https://www.instagram.com/chapman__entrepreneurs" },
  ...
  { name: "Math Club", desc: "Math Club is a club where we examine more closely the intricacies of math in our daily lives and subsequently how we interact with the world because of its existence. Our goal is to share this knowledge with Chapman students of all majors so they can better integrate these mathematical concepts into their own lives.", handle: "", link: "" },
